    ...
    >
      ...
      <section className="relative pt-28 pb-0 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          {/* Action buttons */}
          <motion.div
            className="flex flex-wrap gap-3 mt-8 mb-16"
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div
            className="w-full h-[300px] md:h-[460px] rounded-2xl overflow-hidden"
            ...
            <img
              ...
              onError={(e) => {
                ...
                if (parent) {
                  ...
                  parent.innerHTML = '<span style="font-size:5rem;opacity:0.2">🖥</span>'
                }
              }}
            />
          </div>
      ...
      <main className="max-w-6xl mx-auto px-6 py-20">
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-2 space-y-16">
            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0}>
              ...
              <p className="text-lg leading-relaxed" style={{ color: 'var(--text-primary)', opacity: 0.85 }}>
            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={2}>
              ...
              <div
                ...
                style={{ background: 'var(--bg-card)', borderColor: 'var(--accent)', border: '1px solid var(--card-border)', borderLeftColor: 'var(--accent)', borderLeftWidth: '4px' }}
              >
            ...
            <motion.div variants={fadeUp} initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0}>
              ...
              <div className="space-y-3">
                {project.techStack.map((tech, i) => (
                  ...
                  >
                    <div
                      className="w-9 h-9 rounded-lg flex items-center justify-center p-1.5 shrink-0"
                      style={{ background: 'var(--accent-dim)', border: '1px solid var(--accent-border)' }}
                    >
        ...
        >
          ...
          <Link href={`/user/projects/${nextProject.id}`}>
            <div
              className="group p-8 md:p-12 rounded-2xl flex flex-col md:flex-row items-center gap-8 transition-all duration-300 hover:-translate-y-1"
              style={{
            ...
            >
              <div
                className="w-full md:w-48 h-32 rounded-xl overflow-hidden shrink-0"
              ...
              <div className="flex-1">
                <div className="flex flex-wrap gap-2 mb-3">
                  {nextProject.tags.map((tag, i) => <span key={i} className="tag">{tag}</span>)}
                </div>
                <h3 className="text-xl font-bold mb-2" style={{ fontFamily: "'Syne', sans-serif", color: 'var(--text-heading)' }}>{nextProject.title}</h3>
                <p className="text-sm" style={{ color: 'var(--text-muted)' }}>{nextProject.tagline}</p>
              </div>
              <div
                className="shrink-0 w-10 h-10 rounded-full flex items-center justify-center transition-all group-hover:bg-[var(--accent)] group-hover:text-[var(--bg-primary)]"
